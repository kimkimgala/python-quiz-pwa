const CACHE_NAME='python-quiz-pwa-v1-2';
const APP_FILES=['./','./index.html','./manifest.json','./catalog.json','./questions.json','./courses/cassette-demo.json','./icon-192.png','./icon-512.png'];
